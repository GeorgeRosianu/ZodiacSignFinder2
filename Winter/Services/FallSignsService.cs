...
{
    public class WinterSignsService : WinterZodiacSigns.WinterZodiacSignsBase
    {
        private readonly ZodiacOperations zodiacOperations = new ZodiacOperations();
        private readonly ILogger<WinterSignsService> _logger;
        public WinterSignsService(ILogger<WinterSignsService> logger)
        {
            _logger = logger;
        }

        public override Task<WinterZodiacResponse> FindZodiacSign(WinterZodiacRequest request, ServerCallContext context)
        {
            ...
            return Task.FromResult(new WinterZodiacResponse
            {
